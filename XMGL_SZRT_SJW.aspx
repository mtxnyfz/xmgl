<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMGL_SZRT_SJW.aspx.cs" Inherits="XMGL.Web.admin.XMGL_SZRT_SJW" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Panel7" runat="server" />
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="申报项目管理(双证融通)" ShowBorder="false" ShowHeader="True" Layout="VBox"
