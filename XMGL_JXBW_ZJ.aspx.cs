...
{
    public partial class XMGL_JXBW_ZJ : System.Web.UI.Page
    {
        ...
        protected void databind()
        {
            ...
            sqlstr = "select * from JXBW,XM_ZJSZ WHERE  SFSC =0 and JXBW.ZT>=3 and JXBW.ZT!=4 and JXBW.ZT!=6 AND XM_ZJSZ.XMBH=JXBW.XMBH and XM_ZJSZ.ZJID='"+pb.GetIdentityId()+"'"; 
