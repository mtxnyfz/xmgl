<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMGL_TYL_YXGL.aspx.cs" Inherits="XMGL.Web.admin.XMGL_TYL_YXGL" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Panel7" runat="server" />
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="申报项目管理(通用类)" ShowBorder="false" ShowHeader="True" Layout="VBox"
