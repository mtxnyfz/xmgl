<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMGL_SZRT_Add.aspx.cs" Inherits="XMGL.Web.admin.XMGL_SZRT_Add" %>
                                                    ...
                                                    <Items>
                                                        ...
                                                        <f:Panel runat="server" ShowHeader="False" ShowBorder="False" ColumnWidth="25%" Margin="5 5 2 10" ID="Panel75">
                                                            <Items>
                                                                ...
                                                                <f:TextBox runat="server" ShowLabel="False" Label="任务分工" ID="RWFG2" Required="True" ShowRedStar="True" Width="200px"></f:TextBox>
                                                            </Items>
                                                        </f:Panel>
                                ...
                                <f:SimpleForm ID="SimpleForm_step4" BoxConfigAlign="Stretch" LabelAlign="Top" BodyPadding="5px" ShowBorder="false" ShowHeader="false" runat="server" Hidden="true">
                                    <Items>
                                        <f:GroupPanel ID="GroupPanel11" Layout="Anchor" Title="<strong>融通课程设置（至少填报3门课程）</strong>" runat="server">
                                            <Items>
                                                <f:TextBox ID="KCMC1" Label="课程名称" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="KCZYNR1" Label="课程主要内容" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="KCDYZS1" Label="课程对应的证书能力模块" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="KHFS1" Label="考核方式" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                ...
                                <f:SimpleForm ID="SimpleForm_step5" BoxConfigAlign="Stretch" LabelAlign="Top" BodyPadding="5px" ShowBorder="false" ShowHeader="false" runat="server" Hidden="true">
                                    <Items>
                                        <f:GroupPanel ID="GroupPanel6" Layout="Anchor" Title="<strong>专业教师信息</strong>" runat="server">
                                            <Items>
                                                <f:TextBox ID="XM3" Label="姓名" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="ZC3" Label="职称" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="ZJKC3" Label="主讲课程" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:TextBox ID="ZYZG3" Label="职业资格证书" Required="true" ShowRedStar="true" ColumnWidth="25%" runat="server" Readonly="false" Margin="0 5 5 2">
                                                </f:TextBox>
                                                <f:DropDownList ID="ZJZ3" runat="server" Label="专/兼职" Required="true" ShowRedStar="true" ColumnWidth="25%" Margin="0 5 2 0"></f:DropDownList>
                                                ...
                                                <f:Form runat="server" Title="添加项目验收指标" ID="Form5" Margin="0 0 10 0">
                                                    <Items>
                                                        <f:Panel ID="Panel30" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                            <Items>
                                                                <f:TextArea ID="jsmb1" runat="server" Height="100px" Label="建设目标" Text="" ColumnWidth="80%" Margin="10 5 10 5" Required="true" ShowRedStar="True"></f:TextArea>
                                                            </Items>

                                                        </f:Panel>
                                                        <f:Panel ID="Panel31" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                            <Items>
                                                                <f:DatePicker runat="server" Required="true" EnableEdit="false" Label="计划验收日期" EmptyText="请选择日期" ID="jhysrq1" ShowRedStar="True" ColumnWidth="80%" Margin="0 5 10 5"></f:DatePicker>
                                                            </Items>

                                                        </f:Panel>
                                                        <f:Panel ID="Panel32" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                            <Items>
                                                                <f:TextArea ID="ysyd1" runat="server" Height="200px" Label="验收要点" Text="" ColumnWidth="80%" Margin="0 5 10 5" Required="true" ShowRedStar="True"></f:TextArea>
                                                            </Items>
                                            ...
                                            <Items>
                                                <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" runat="server" Width="550px" EnableCollapse="true"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <f:FileUpload runat="server" ID="FileUpload1" EmptyText="请选择上传附件一" Label="“双证融通”培养模式人才改革方案" Required="true"
                                                            ShowRedStar="true">
                                                        </f:FileUpload>
                                            ...
                                            <Items>
                                                <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" runat="server" Width="550px" EnableCollapse="true"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <f:FileUpload runat="server" ID="FileUpload2" EmptyText="请选择上传附件二" Label="本专业现行人才培养方案" Required="true"
                                                            ShowRedStar="true">
                                                        </f:FileUpload>
                                                        <f:HyperLink ID="HyperLink2" Text="下载本专业现行人才培养方案模板" Target="_blank" NavigateUrl="WordMaster/SZRT/附件二本专业现行人才培养方案.doc" runat="server">
                                                        </f:HyperLink>
