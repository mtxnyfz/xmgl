<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TYL_XMGL_Add.aspx.cs" Inherits="XMGL.Web.admin.TYL_XMGL_Add" %>
                                        ...
                                        <f:GroupPanel ID="GroupPanel4" Layout="Anchor" Title="<strong>申报项目建设方案</strong>" runat="server">
                                            <Items>
                                                <f:GroupPanel ID="GroupPanel32" Layout="Anchor" Title="<strong>申报理由</strong>" runat="server">
                                                    <Items>
                                                        <f:TextArea ID="txtSBXMJSFA_SBLY" Label="申报理由" Required="true" ShowRedStar="true" ColumnWidth="100%" runat="server" Margin="0 5 2 0" Height="200px" EmptyText="请说明开展项目建设的必要性和可行性。（不超过500字）" MaxLength="700">
                                                        </f:TextArea>
                                                    </Items>
                                                </f:GroupPanel>
                                                <f:GroupPanel ID="GroupPanel33" Layout="Anchor" Title="<strong>建设目标</strong>" runat="server">
                                                    <Items>
                                                        <f:TextArea ID="txtSBXMJSFA_JSMB" Label="建设目标" Required="true" ShowRedStar="true" ColumnWidth="100%" runat="server" Margin="0 5 2 0" Height="200px" EmptyText="请阐述项目建设总体目标。（不超过500字）" MaxLength="700">
                                                        </f:TextArea>
                                                    </Items>
                                                </f:GroupPanel>
                                                <f:GroupPanel ID="GroupPanel34" Layout="Anchor" Title="<strong>具体举措</strong>" runat="server">
                                                    <Items>
                                                        <f:TextArea ID="txtSBXMJSFA_JTJC" Label="具体举措" Required="true" ShowRedStar="true" ColumnWidth="100%" runat="server" Margin="0 5 2 0" Height="200px" EmptyText="请阐述具体建设内容及举措。（不超过1000字）" MaxLength="1200">
                                                        </f:TextArea>
                                                    </Items>
                                                </f:GroupPanel>
                                                <f:GroupPanel ID="GroupPanel35" Layout="Anchor" Title="<strong>经费安排</strong>" runat="server">
                                                    <Items>
                                                        <f:TextArea ID="txtSBXMJSFA_JFAP" Label="经费安排" Required="true" ShowRedStar="true" ColumnWidth="100%" runat="server" Margin="0 5 2 0" Height="200px" EmptyText="请阐述项目总体需要经费、来源和主要用途。（不超过500字）" MaxLength="700">
                                                        </f:TextArea>
                                                    </Items>
                                                </f:GroupPanel>
                                                <f:GroupPanel ID="GroupPanel36" Layout="Anchor" Title="<strong>实施计划</strong>" runat="server">
                                                    <Items>
                                                        <f:TextArea ID="txtSBXMJSFA_SSJH" Label="实施计划" Required="true" ShowRedStar="true" ColumnWidth="100%" runat="server" Margin="0 5 2 0" Height="200px" EmptyText="请阐述项目实施计划，须按季度分别填写。（不超过500字）" MaxLength="700">
                                                        </f:TextArea>
                                                    </Items>
                                                </f:GroupPanel>
                                            </Items>
                                            ...
                                            <Items>
                                                <f:GroupPanel ID="GroupPanel9" Layout="Anchor" Title="<strong>申请专项经费</strong>" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel2" Layout="Anchor" Title="<strong>1、教学科研经费</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                                <f:Panel ID="Panel37" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                                    <Items>
                                                                        <f:TextBox ID="txtJFYS_ZXJF_JXKYJF_SM" Label="具体使用说明" Required="true" ShowRedStar="true" ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>
                                                                        <f:NumberBox ID="txtJFYS_ZXJF_JXKYJF_JFYS" runat="server" Label="经费预算(万元)" MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="33%" Margin="0 5 2 0" AutoPostBack="true" OnTextChanged="ZXJFSum_TextChanged"></f:NumberBox>
                                                                        <f:TextBox ID="txtJFYS_ZXJF_JXKYJF_BZ" Label="备注"  ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>
                                                                    </Items>
                                                                </f:Panel>
                                                            </Items>
                                                        </f:GroupPanel>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel6" Layout="Anchor" Title="<strong>3、仪器设备经费</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel11" Layout="Anchor" Title="<strong>5、业务费（包括差旅、印刷、交通等）</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                            ...
                                                            <Items>
                                                                <f:Panel ID="Panel10" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                                    <Items>
                                                                      ...
                                                                      <%--  <f:TextBox ID="txtJFYS_ZXJF_JFGSHJ_BZ" Label="备注"  ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>--%>
                                                                    </Items>
                                                                </f:Panel>
                                                            </Items>
                                                        </f:GroupPanel>
                                                ...
                                                <f:GroupPanel ID="GroupPanel10" Layout="Anchor" Title="<strong>学校配套经费</strong>" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel13" Layout="Anchor" Title="<strong>1、教学科研经费</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                                <f:Panel ID="Panel12" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                                    <Items>
                                                                        <f:TextBox ID="txtJFYS_XXPTJF_JXKYJF_SM" Label="具体使用说明" Required="true" ShowRedStar="true" ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>
                                                                        <f:NumberBox ID="txtJFYS_XXPTJF_JXKYJF_JFYS" runat="server" Label="经费预算(万元)" MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="33%" Margin="0 5 2 0" AutoPostBack="true" OnTextChanged="XXPTJFSum_TextChanged"></f:NumberBox>
                                                                        <f:TextBox ID="txtJFYS_XXPTJF_JXKYJF_BZ" Label="备注"  ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>
                                                                    </Items>
                                                                </f:Panel>
                                                            </Items>
                                                        </f:GroupPanel>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel15" Layout="Anchor" Title="<strong>3、仪器设备经费</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                        ...
                                                        <f:GroupPanel ID="GroupPanel17" Layout="Anchor" Title="<strong>5、业务费（包括差旅、印刷、交通等）</strong>" runat="server" EnableCollapse="true">
                                                            <Items>
                                                            ...
                                                            <Items>
                                                                <f:Panel ID="Panel17" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                                    <Items>
                                                                      ...
                                                                      <%--  <f:TextBox ID="txtJFYS_XXPTJF_JFGSHJ_BZ" Label="备注"  ColumnWidth="33%" runat="server" Margin="0 5 2 0"></f:TextBox>--%>
                                                                    </Items>
                                                                </f:Panel>
                                                            </Items>
                                                        </f:GroupPanel>
                                            ...
                                            <Items>
                                                ...
                                                <f:SimpleForm ID="SimpleForm3" BodyPadding="5px" runat="server" EnableCollapse="true"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <f:FileUpload runat="server" ID="FileUpload3" EmptyText="请选择上传附件" Label="项目预算明细表" Required="true" ShowRedStar="true" OnFileSelected="FileUpload3_FileSelected" AutoPostBack="true">
                                                        </f:FileUpload>
                                                        <f:HyperLink ID="HyperLink3" Text="下载项目预算明细表模板" Target="_blank" NavigateUrl="WordMaster/模板下载/通用类/附件：项目预算明细表.doc" runat="server">
                                                        </f:HyperLink>
