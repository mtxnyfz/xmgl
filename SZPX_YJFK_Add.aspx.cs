...
{
    public partial class SZPX_YJFK_Add : System.Web.UI.Page
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string sqlstr = "";
                    if (ViewState["xmbh"].ToString().Contains("2015-04"))
                    {
                        sqlstr = "update SZPX_XMSB set SFSC=0, ZT=6 where XMBH='" + ViewState["xmbh"].ToString() + "'";
                    }
