...
{
    public partial class Savant_Add : System.Web.UI.Page
    {
        ...
        protected void btnSaveRefresh_Click(object sender, EventArgs e)
        {
            ...
            zjb_model.Experts_OPIID =pb.GetIdentityId();
            zjb_model.Experts_OPITIME = DateTime.Now;
            int _flag = zjb_bll.Add(zjb_model);
            if (_flag > 0)
            {
                Alert.Show("添加成功！", MessageBoxIcon.Information);
            }
            else
            {
