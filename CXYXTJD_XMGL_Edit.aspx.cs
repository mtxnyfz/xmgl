...
{
    public partial class CXYXTJD_XMGL_Edit : System.Web.UI.Page
    {
        ...
        public void InitData ()
        {
            ...
            TextBox_jdmc.Text = xm_model.JDMC;
            txt_xxmc.Text = xm_model.XXMC;
            txt_xxdm.Text = xm_model.XXDM;
            txt_SXSXQK_SXSXCSSZMJ.Text = xm_model.SXSXQK_SXSXCSSZMJ.ToString();
            txt_SXSXQK_SXSXCSJZMJ.Text = xm_model.SXSXQK_SXSXCSJZMJ.ToString();
            txt_SXSXQK_XYSXSBZZ.Text = xm_model.SXSXQK_XYSXSBZZ.ToString();
            txt_SXSXQK_XYSXYQSB.Text = xm_model.SXSXQK_XYSXYQSB.ToString();
            txt_SXSXQK_SBSJ.Text = xm_model.SXSXQK_SBSJ.ToString();
            txt_SXSXQK_SXSXKCMS.Text = xm_model.SXSXQK_SXSXKCMS.ToString();
            txt_SXSXQK_JSNNJPXRS.Text = xm_model.SXSXQK_JSNNJPXRS.ToString();
            txt_JDFZRXX_XM.Text = xm_model.JDFZRXX_XM;
            txt_JDFZRXX_BMJZF.Text = xm_model.JDFZRXX_BMJZF;
            txt_JDFZRXX_ZYJSZW.Text = xm_model.JDFZRXX_ZYJSZW;
            txt_JDFZRXX_ZYZGZS.Text = xm_model.JDFZRXX_ZYZGZS;
            txt_JDFZRXX_BGDH.Text = xm_model.JDFZRXX_BGDH;
            txt_JDFZRXX_CZ.Text = xm_model.JDFZRXX_CZ;
            txt_JDFZRXX_SJ.Text = xm_model.JDFZRXX_SJ;
            txt_JDFZRXX_DZYX.Text = xm_model.JDFZRXX_DZYX;
            txt_JDFZRXX_JSYFYFW.Text = xm_model.JDFZRXX_JSYFYFW;
            txt_JDFZRXX_BRZHYQYJZ.Text = xm_model.JDFZRXX_BRZHYQYJZ;
            txt_JDZZGJSX.Text = xm_model.JDZZGJSX;
            txt_JDJSFA_SBLY.Text = xm_model.JDJSFA_SBLY;
            txt_JSGYHCPKF_PTMC.Text = xm_model.JSGYHCPKF_PTMC;
            txt_JSGYHCPKF_XM.Text = xm_model.JSGYHCPKF_XM;
            txt_JSGYHCPKF_BMJXZZF.Text = xm_model.JSGYHCPKF_BMJXZZF;
            txt_JSGYHCPKF_ZYJSZW.Text = xm_model.JSGYHCPKF_ZYJSZW;
            txt_JSGYHCPKF_ZYZGZS.Text = xm_model.JSGYHCPKF_ZYZGZS;
            txt_JSGYHCPKF_BGDH.Text = xm_model.JSGYHCPKF_BGDH;
            txt_JSGYHCPKF_CZ.Text = xm_model.JSGYHCPKF_CZ;
            txt_JSGYHCPKF_SJ.Text = xm_model.JSGYHCPKF_SJ;
            txt_JSGYHCPKF_DZYX.Text = xm_model.JSGYHCPKF_DZYX;

            txt_JSGYHCPKF_QYMC1.Text = xm_model.JSGYHCPKF_QYMC1;
            txt_JSGYHCPKF_LXRXMJZW1.Text = xm_model.JSGYHCPKF_LXRXMJZW1;
            txt_JSGYHCPKF_LXFS1.Text = xm_model.JSGYHCPKF_LXFS1;
            txt_JSGYHCPKF_QYMC2.Text = xm_model.JSGYHCPKF_QYMC2;
            txt_JSGYHCPKF_LXRXMJZW2.Text = xm_model.JSGYHCPKF_LXRXMJZW2;
            txt_JSGYHCPKF_LXFS2.Text = xm_model.JSGYHCPKF_LXFS2;
            txt_JSGYHCPKF_QYMC3.Text = xm_model.JSGYHCPKF_QYMC3;
            txt_JSGYHCPKF_LXRXMJZW3.Text = xm_model.JSGYHCPKF_LXRXMJZW3;
            txt_JSGYHCPKF_LXFS3.Text = xm_model.JSGYHCPKF_LXFS3;

            //研发领域-选项（用|分隔）
            string [] kfly_xx_list = xm_model.JSGYHCPKF_YFLY_XX.Split( '|' );

            for ( int i = 0 ; i < kfly_xx_list.Length ; i++ )
            {
                foreach ( var cbl in cbl_JSGYHCPKF_YFLY_XX.Items )
                {
                    if ( cbl.Value.Equals( kfly_xx_list [ i ] ) )
                    {
                        cbl.Selected = true;
                    }
            ...
            txt_JSGYHCPKF_YFLY_QT.Text = xm_model.JSGYHCPKF_YFLY_QT;
            txt_JSGYHCPKF_PTGNJJ.Text = xm_model.JSGYHCPKF_PTGNJJ;
            txt_JSGYHCPKF_PTWLGYHJJZB.Text = xm_model.JSGYHCPKF_PTWLGYHJJZB;
            txt_SXSXPT_PTMC.Text = xm_model.SXSXPT_PTMC;
            txt_SXSXPT_XM.Text = xm_model.SXSXPT_XM;
            txt_SXSXPT_BMJXZZW.Text = xm_model.SXSXPT_BMJXZZW;
            txt_SXSXPT_ZYJSZW.Text = xm_model.SXSXPT_ZYJSZW;
            txt_SXSXPT_ZYZGZS.Text = xm_model.SXSXPT_ZYZGZS;
            txt_SXSXPT_BGDH.Text = xm_model.SXSXPT_BGDH;
            txt_SXSXPT_CZ.Text = xm_model.SXSXPT_CZ;
            txt_SXSXPT_SJ.Text = xm_model.SXSXPT_SJ;
            txt_SXSXPT_DZYX.Text = xm_model.SXSXPT_DZYX;
            txt_SXSXPT_PTGNJJ.Text = xm_model.SXSXPT_PTGNJJ;
            txt_SXSXPT_PTWLSNJSMB.Text = xm_model.SXSXPT_PTWLSNJSMB;
            txt_JNDSGZS_GZSMC.Text = xm_model.JNDSGZS_GZSMC;
            txt_JNDSGZS_XM.Text = xm_model.JNDSGZS_XM;
            rbtn_JNDSGZS_XB.SelectedValue = xm_model.JNDSGZS_XB;
            txt_JNDSGZS_MZ.Text = xm_model.JNDSGZS_MZ;
            dp_JNDSGZS_CSNY.SelectedDate = xm_model.JNDSGZS_CSNY;
            dp_JNDSGZS_CJGZSJ.SelectedDate = xm_model.JNDSGZS_CJGZSJ;
            txt_JNDSGZS_ZZMM.Text = xm_model.JNDSGZS_ZZMM;
            txt_JNDSGZS_CSSY.Text = xm_model.JNDSGZS_CSSY;
            txt_JNDSGZS_ZYJNDJ.Text = xm_model.JNDSGZS_ZYJNDJ;
            txt_JNDSGZS_SJ.Text = xm_model.JNDSGZS_SJ;
            txt_JNDSGZS_YX.Text = xm_model.JNDSGZS_YX;
            txt_JNDSGZS_GZDWJZW.Text = xm_model.JNDSGZS_GZDWJZW;

            txt_JNDSGZS_GEJL.Text = xm_model.JNDSGZS_GEJL;
            txt_JNDSGZS_HSBJYSJLHGJZL.Text = xm_model.JNDSGZS_HSBJYSJLHGJZL;
            txt_JNDSGZS_ZYCXFMCG.Text = xm_model.JNDSGZS_ZYCXFMCG;
            txt_JNDSGZS_GZSJJ.Text = xm_model.JNDSGZS_GZSJJ;
            txt_JNDSGZS_GZSWLSNJSRW.Text = xm_model.JNDSGZS_GZSWLSNJSRW;
            txt_JTCS.Text = xm_model.JTCS;
            txt_JFAP.Text = xm_model.JFAP;
            txt_SSJH.Text = xm_model.SSJH;
            //专项经费
            NumberBox_sqzxjfhj.Text = xm_model.ZXJF_SQZXJF.ToString();
            DatePicker_sqzxjfzxksrq.SelectedDate = xm_model.ZXJF_ZXKSSJ;
            DatePicker_sqzxjfzxjsrq.SelectedDate = xm_model.ZXJF_ZXJSSJ;


            NumberBox_sqzxjfkcjcjf_2015.Text = xm_model.ZXJF_KCJCJF2015.ToString();
            NumberBox_sqzxjfkcjcjf_2016.Text = xm_model.ZXJF_KCJCJF2016.ToString();
            NumberBox_sqzxjfkcjcjf_2017.Text = xm_model.ZXJF_KCJCJF2017.ToString();

            NumberBox_sqzxjfszpxjf_2015.Text = xm_model.ZXJF_SZJSJF2015.ToString();
            NumberBox_sqzxjfszpxjf_2016.Text = xm_model.ZXJF_SZJSJF2016.ToString();
            NumberBox_sqzxjfszpxjf_2017.Text = xm_model.ZXJF_SZJSJF2017.ToString();

            NumberBox_sqzxjfyqsbjf_2015.Text = xm_model.ZXJF_YQSBJF2015.ToString();
            NumberBox_sqzxjfyqsbjf_2016.Text = xm_model.ZXJF_YQSBJF2016.ToString();
            NumberBox_sqzxjfyqsbjf_2017.Text = xm_model.ZXJF_YQSBJF2017.ToString();

            NumberBox_sqzxjfwpryfy_2015.Text = xm_model.ZXJF_WPRYFY2015.ToString();
            NumberBox_sqzxjfwpryfy_2016.Text = xm_model.ZXJF_WPRYFY2016.ToString();
            NumberBox_sqzxjfwpryfy_2017.Text = xm_model.ZXJF_WPRYFY2017.ToString();


            NumberBox_sqzxjfywf_2015.Text = xm_model.ZXJF_YWF2015.ToString();
            NumberBox_sqzxjfywf_2016.Text = xm_model.ZXJF_YWF2016.ToString();
            NumberBox_sqzxjfywf_2017.Text = xm_model.ZXJF_YWF2017.ToString();

            NumberBox_sqzxjfgshj_2015.Text = xm_model.ZXJF_JFGSHJ2015.ToString();
            NumberBox_sqzxjfgshj_2016.Text = xm_model.ZXJF_JFGSHJ2016.ToString();
            NumberBox_sqzxjfgshj_2017.Text = xm_model.ZXJF_JFGSHJ2017.ToString();


            //学校经费
            NumberBox_xxptjfhj.Text = xm_model.XXPTJF_XXPTJF.ToString();
            DatePicker_xxptjfzxksrq.SelectedDate = xm_model.XXPTJF_ZXKSSJ;
            DatePicker_xxptjfzxjsrq.SelectedDate = xm_model.XXPTJF_ZXJSSJ;


            NumberBox_xxptkcjcjf_2015.Text = xm_model.XXPTJF_KCJCJF2015.ToString();
            NumberBox_xxptkcjcjf_2016.Text = xm_model.XXPTJF_KCJCJF2016.ToString();
            NumberBox_xxptkcjcjf_2017.Text = xm_model.XXPTJF_KCJCJF2017.ToString();

            NumberBox_xxptszpxf_2015.Text = xm_model.XXPTJF_SZJSJF2015.ToString();
            NumberBox_xxptszpxf_2016.Text = xm_model.XXPTJF_SZJSJF2016.ToString();
            NumberBox_xxptszpxf_2017.Text = xm_model.XXPTJF_SZJSJF2017.ToString();

            NumberBox_xxptyqsbjf_2015.Text = xm_model.XXPTJF_YQSBJF2015.ToString();
            NumberBox_xxptyqsbjf_2016.Text = xm_model.XXPTJF_YQSBJF2016.ToString();
            NumberBox_xxptyqsbjf_2017.Text = xm_model.XXPTJF_YQSBJF2017.ToString();

            NumberBox_xxptwpryfy_2015.Text = xm_model.XXPTJF_WPRYJF2015.ToString();
            NumberBox_xxptwpryfy_2016.Text = xm_model.XXPTJF_WPRYJF2016.ToString();
            NumberBox_xxptwpryfy_2017.Text = xm_model.XXPTJF_WPRYJF2017.ToString();


            NumberBox_xxptywf_2015.Text = xm_model.XXPTJF_YWF2015.ToString();
            NumberBox_xxptywf_2016.Text = xm_model.XXPTJF_YWF2016.ToString();
            NumberBox_xxptywf_2017.Text = xm_model.XXPTJF_YWF2017.ToString();

            NumberBox_xxptgshj_2015.Text = xm_model.XXPTJF_JFGSHJ2015.ToString();
            NumberBox_xxptgshj_2016.Text = xm_model.XXPTJF_JFGSHJ2016.ToString();
            NumberBox_xxptgshj_2017.Text = xm_model.XXPTJF_JFGSHJ2017.ToString();
            ...
            FileUpload1.EmptyText = XMFJ_Mode.XMKXXFXBGWJM;
            FileUpload2.EmptyText = XMFJ_Mode.YXXSALWJM;
            FileUpload3.EmptyText = XMFJ_Mode.XMYSMXWJM;
        ...
        protected void Button13_Click ( object sender, EventArgs e )
        {
            ...
            //{
                ...
                if (new BuildWord().BuildWord_2015ProjectDeclaration_CJYXTJD(tmppath, savepath, xm_model.XMBH))
                {
                    ...
                    model = wordBll.GetModelList("XMBH='" + xm_model.XMBH + "'")[0];
