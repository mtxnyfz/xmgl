                ...
                <f:SimpleForm ID="Form2" BoxConfigAlign="Stretch" LabelAlign="Top" BodyPadding="5px" ShowBorder="false" ShowHeader="false" runat="server" Title="填写专业教师基本信息">
                    <Items>
                        ...
                        <f:Panel ID="Panel19" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                                <f:Panel ID="Panel3" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        <f:Label runat="server" ID="Label_jsxm" Text="教师姓名：" ShowRedStar="true"></f:Label>
                                        <f:TextBox ID="TextBox1_jsxm" Label="教师姓名" Width="100px" Required="true" ShowRedStar="true" runat="server" ShowLabel="false"></f:TextBox>
                                    </Items>
                                </f:Panel>
                                <f:Panel ID="Panel49" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        <f:Label ID="Label4" runat="server" Text="请选择出生年月："></f:Label>
                                        <f:DatePicker runat="server" Required="true" EnableEdit="false" Label="出生年月" EmptyText="请选择出生年月" ID="DatePicker_csny" ShowRedStar="True" ShowLabel="false" DateFormatString="yyyy-MM"></f:DatePicker>
                                    </Items>
                                </f:Panel>
                        ...
                        <f:Panel ID="Panel20" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                            <Items>
                                ...
                                <f:Panel ID="Panel55" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        <f:ContentPanel ID="ContentPanel6" runat="server" ShowBorder="false" ShowHeader="false">
                                            <Items>
                                            </Items>
                                        </f:ContentPanel>
                                    </Items>
