...
{
    public partial class XMGL_MZWHCC_Up : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string sqlstr2 = "select * from WHCC where XMBH='" + ViewState["xmbh"].ToString() + "'";
                BLL.WHCC WHCC_Bll = new BLL.WHCC();
                Model.WHCC WHCC_Model = null;
                ...
                if (sdr2.Read())
                {
                    ...
                    WHCC_Model = WHCC_Bll.GetModel(Convert.ToInt32(sdr2["ID"].ToString().Trim()));
                    ViewState["ID"] = WHCC_Model.ID;
                    dp_setvalue(DROP_zymc1, WHCC_Model.ZYMC);
                    TextBox_ZYMCFX1.Text = WHCC_Model.ZYMCFX;
                    TextBox_ZYDM2.Text = WHCC_Model.ZYDM2;
                    TextBox_XYNX1.Text = WHCC_Model.XYNX;
                    TextBox_ZYSZSJ1.Text = WHCC_Model.ZYSZSJ;
                    TextBox_SJBYSSJ1.Text = WHCC_Model.SJBYSSJ;
                    NUM_SNBYSZS1.Text = WHCC_Model.JSNLJBYSS.ToString();
                    NUM_ZYZSRS1.Text = WHCC_Model.ZYZSRS.ToString();
                    NUM_ZYZXSS1.Text = WHCC_Model.ZYZXSS.ToString();
                    dp_setvalue(DROP_WHYCXM1, WHCC_Model.WHYCXM);
                    TextBox_WHYCXMMC1.Text = WHCC_Model.WHYCMC;
                    ZYDT_XM1.Text = WHCC_Model.DTR_XM;
                    dp_setvalue(ZYDT_XB1, WHCC_Model.DTR_XB); 
                    ZYDT_CSNY1.Text = WHCC_Model.DTR_CSNY;
                    ZYFZR_ZGXL1.Text = WHCC_Model.DTR_ZHXL;
                    ZYFZR_XW1.Text = WHCC_Model.DTR_XW;
                    ZYDTR_ZYJSZW2.Text = WHCC_Model.DTR_ZYJSZW;
                    ZYDTR_ZW1.Text = WHCC_Model.DTR_ZW;
                    ZYDTR_LXDH1.Text = WHCC_Model.DTR_LXDH;
                    ZYDTR_YX1.Text = WHCC_Model.DTR_YX;
                    JS_ZRJSZS.Text = WHCC_Model.ZRJSZS.ToString();
                    JS_GJZCRS1.Text = WHCC_Model.GJZCRS.ToString();
                    JS_GJZCBL1.Text = WHCC_Model.GJZCBL;
                    JS_SHXRS1.Text = WHCC_Model.SSRS.ToString();
                    ZYFZR_ZYZGZS1.Text = WHCC_Model.SSBL;
                    JS_JZJSZRS1.Text = WHCC_Model.JZJSZS.ToString();
                    JS_GJZCRS2.Text = WHCC_Model.JZJSGJZCRS.ToString();
                    ZYFZR_ZKSBL1.Text = WHCC_Model.ZYZKSBL;
                    dp_setvalue(ZYDT_YWCCR1, WHCC_Model.YWWHCCR);
                    CCR_XM1.Text = WHCC_Model.CCR_XM;
                    dp_setvalue(CCR_XB1, WHCC_Model.CCR_XB);
                    JS_GJZCBL2.Text = WHCC_Model.CCR_CSNY;
                    JS_FWZYCMC1.Text = WHCC_Model.WHYCCCXMMC;
                    dp_setvalue(CCR_ZSJB1, WHCC_Model.ZSJB); 
                    TextBox_SJBYSSJ1.Text = WHCC_Model.SJBYSSJ;
                    ZYFZR_ZSHDRQ1.Text = WHCC_Model.ZSHDRQ;
                    TextArea_ZYDSFZYQK1.Text = WHCC_Model.ZYDSFZYQK;
                    TextArea_ZYJJ1.Text = WHCC_Model.ZYJJ;
                    TextArea_ZYJSQK1.Text = WHCC_Model.ZYJSQK;
                    TextArea_RCPYQK1.Text = WHCC_Model.RCPYQK;
                    TextArea_ZYJSGH1.Text = WHCC_Model.ZYJSGH;
        ...
        protected void databind_whycxm1()
        {
            ...
            DROP_WHYCXM1.Items.Add("请选择", "0");
            DROP_WHYCXM1.Items.Add("国家级", "1");
            DROP_WHYCXM1.Items.Add("省级", "2");
            DROP_WHYCXM1.Items.Add("无", "3");
        ...
        protected void databind_ywccr1()
        {
            ...
            ZYDT_YWCCR1.Items.Add("请选择", "0");
            ZYDT_YWCCR1.Items.Add("有", "1");
            ZYDT_YWCCR1.Items.Add("无", "2");
        ...
        protected void databind_xb1()
        {
            ...
            ZYDT_XB1.Items.Add("请选择", "0");
            ZYDT_XB1.Items.Add("男", "1");
            ZYDT_XB1.Items.Add("女", "2");
            dp_setvalue(ZYDT_XB1, "请选择");
            CCR_XB1.Items.Clear();
            CCR_XB1.Items.Add("请选择", "0");
            CCR_XB1.Items.Add("男", "1");
            CCR_XB1.Items.Add("女", "2");
        ...
        protected void databind_zsjb1()
        {
            ...
            CCR_ZSJB1.Items.Add("请选择", "0");
            CCR_ZSJB1.Items.Add("国家级", "1");
            CCR_ZSJB1.Items.Add("省级", "2");
            CCR_ZSJB1.Items.Add("其他", "2");
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            if (sdr2.Read())
            {
                ...
                //WHCC_Model.XMBH = AutoNumber("WHCC_2015-01-");
                ...
                WHCC_Model.ZYMC = DROP_zymc1.Text.Trim();
                ...
                WHCC_Model.ZYSZSJ = TextBox_ZYSZSJ1.Text.Trim();
                ...
                if (new BuildWord().BuildWord_2015ProjectDeclaration_WHCC(tmppath, savepath, WHCC_Model.XMBH))
                {
                    ...
                    model = wordBll.GetModelList("XMBH='" + WHCC_Model.XMBH + "'")[0];
        ...
        protected void DROP_zymc1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (sdr.Read())
                {
                    ...
                    TextBox_ZYSZSJ1.Text = sdr["ZYKBSJ"].ToString().Trim();
                    TextBox_ZYSZSJ1.Enabled = false;
                    ZYDT_XM1.Text = sdr["ZYFZR_XM"].ToString().Trim();
