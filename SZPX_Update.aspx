<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SZPX_Update.aspx.cs" Inherits="XMGL.Web.admin.SZPX_Update"
                                    ...
                                    <f:Panel ID="Panels2" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false"
                                        ...
                                        <Items>
                                            ...
                                            <f:TextBox ID="XMSB_DWMC" Label="单位名称" Margin="0 0 2 0" Required="true" ShowRedStar="true"
                                                MaxLength="500" ColumnWidth="100%" runat="server" Readonly="true" Enabled="false">
                                            </f:TextBox>
                                        </Items>
                                    </f:Panel>
                                        ...
                                        <Toolbars>
                                            <f:Toolbar ID="Toolbar13" runat="server" ToolbarAlign="Right" Position="Bottom">
                                                <Items>
                                                    ...
                                                    <f:Button ID="Button13" Text="确认修改" ValidateForms="SimpleForm_step2,SimpleForm_step3,SimpleForm_step4,SimpleForm_step5,SimpleForm_step9"
                                                        ValidateMessageBox="true" runat="server" OnClick="SMSB_Update_Click" Margin="10 100 10 10">
                                                    </f:Button>
                                                </Items>
                                            </f:Toolbar>
                                        </Toolbars>
