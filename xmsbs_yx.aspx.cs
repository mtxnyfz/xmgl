...
{
    public partial class xmsbs_yx : System.Web.UI.Page
    {
        ...
        protected void Grid1_databind()
        {
            ...
            DataTable dt = DbHelperSQL.Query("select distinct ID,XMSBSMBMC FROM XMSBSMB").Tables[0];
            Grid1.DataSource = dt;
            Grid1.DataBind();
        }
        ...
        protected void Grid2_databind()
        {
            ...
            string ID = values[0].ToString().Trim();
            string sqlstr = "select XMSBSMB_YX.ID AS ID,  XMSBSMB_YX.XXDM AS XXDM,XXJBQKB.XXMC AS XXMC FROM XMSBSMB_YX,XXJBQKB where XMSBSMB_YX.XXDM=XXJBQKB.XXDM AND XMSBSMB_YX.ID='" + ID + "'";
        ...
        protected void Grid2_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            string ID = values[0].ToString().Trim();
            string XXDM = values[1].ToString().Trim();


            if (e.CommandName == "Delete")
            {
                string sqlstr = "delete XMSBSMB_YX where ID='" + ID + "' and XXDM='" + XXDM + "'";
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            string addUrl = String.Format("smsbs_yx_addnew.aspx?id={0}", ids[0]);
