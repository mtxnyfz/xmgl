<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JSJNJS_XMGL_YXGL.aspx.cs" Inherits="XMGL.Web.admin.JSJNJS_XMGL_YXGL" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="项目申报书(技术技能竞赛)管理" ShowBorder="false" ShowHeader="True" Layout="VBox"
