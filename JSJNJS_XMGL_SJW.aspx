<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JSJNJS_XMGL_SJW.aspx.cs" Inherits="XMGL.Web.admin.JSJNJS_XMGL_SJW" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Panel7" runat="server" />
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="申报项目管理(技术技能竞赛)" ShowBorder="false" ShowHeader="True" Layout="VBox"
             ...
             <Toolbars>
                        <f:Toolbar ID="Toolbar2" runat="server">
                           <Items>
                                ...
                                <f:DropDownList ID="DropDownList2" runat="server" Label="选择学校(单位)"></f:DropDownList>
