<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CXYXTJD_XMGL_Add.aspx.cs" Inherits="XMGL.Web.admin.CXYXTJD_XMGL_Add" %>
                                    ...
                                    <Items>
                                        <f:GroupPanel ID="GroupPanel11" Layout="Anchor" Title="<strong>基地依托专业情况</strong>" runat="server">
                                            <Items>
                                                ...
                                                <f:Grid ID="grid_YTZY" runat="server" Title="已添加基地依托专业情况" Height="300px" Margin="0 5 5 0" EnableMultiSelect="false" EnableCheckBoxSelect="true" DataKeyNames="ID" AllowPaging="true" PageSize="20">
                                                    <Toolbars>
                                ...
                                <f:SimpleForm ID="SimpleForm_step6" BoxConfigAlign="Stretch" LabelAlign="Top" BodyPadding="5px" ShowBorder="false" ShowHeader="false" runat="server" Hidden="true">
                                    <Items>
                                        ...
                                        <f:GroupPanel ID="GroupPanel26" Layout="Anchor" Title="<strong>经费安排</strong>" runat="server">
                                            <Items>
                                                <f:TextArea ID="txt_JFAP" Label="经费安排" Required="true" ShowRedStar="true" ColumnWidth="98%" runat="server" Margin="0 5 2 0" EmptyText="请阐述项目总体需要经费、来源和主要用途。（不超过500字）" MaxLength="800"></f:TextArea>
                                            </Items>
                                        </f:GroupPanel>
                                            ...
                                            <Items>
                                                ...
                                                <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" runat="server" EnableCollapse="true"
                                                    ...
                                                    <Items>
                                                        ...
                                                        <f:FileUpload runat="server" ID="FileUpload2" EmptyText="请选择上传附件二" Label="校企合作优秀案例" Required="true"
                                                            ShowRedStar="true">
                                                        </f:FileUpload>
