...
{
    public partial class user_add_yx : System.Web.UI.Page
    {
        ...
        protected void databind()
        {
            ...
            DataTable dt = DbHelperSQL.Query("select  XXDM,XXMC  FROM XXJBQKB where XXDM='"+xxdm+"'  order by XXMC").Tables[0];
