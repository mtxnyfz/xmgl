...
{
    public partial class JSJNJS_XMGL_Edit : System.Web.UI.Page
    {
        PageBase1 pb = new PageBase1();

        Model.JSJNJS_XM xm_model = new Model.JSJNJS_XM();
        BLL.JSJNJS_XM xm_bll = new BLL.JSJNJS_XM();

        Model.JSJNJS_XMCY xmcy_model = new Model.JSJNJS_XMCY();
        BLL.JSJNJS_XMCY xmcy_bll = new BLL.JSJNJS_XMCY();

        Model.JSJNJS_XMYSZB yszb_model = new Model.JSJNJS_XMYSZB();
        BLL.JSJNJS_XMYSZB yszb_bll = new BLL.JSJNJS_XMYSZB();
        ...
        public void InitData()
        {
            ...
            txtJFYS_ZXJF_JSFA_SM.Text = xm_model.JFYS_ZXJF_JSFA_SM;
            txtJFYS_ZXJF_JSFA_JFYS.Text = xm_model.JFYS_ZXJF_JSFA_JFYS.ToString();
            txtJFYS_ZXJF_JSFA_BZ.Text = xm_model.JFYS_ZXJF_JSFA_BZ;
            ...
            txtJFYS_XXPTJF_JSFA_SM.Text = xm_model.JFYS_XXPTJF_JSFA_SM;
            txtJFYS_XXPTJF_JSFA_JFYS.Text = xm_model.JFYS_XXPTJF_JSFA_JFYS.ToString();
            txtJFYS_XXPTJF_JSFA_BZ.Text = xm_model.JFYS_XXPTJF_JSFA_BZ;
        ...
        public void SumZXJf()
        {
            string JFYS_ZXJF_JSFA_JFYS = txtJFYS_ZXJF_JSFA_JFYS.Text.Trim() == "" ? "0" : txtJFYS_ZXJF_JSFA_JFYS.Text.ToString().Trim();
        ...
        {
            string JFYS_XXPTJF_JSFA_JFYS = txtJFYS_XXPTJF_JSFA_JFYS.Text.Trim() == "" ? "0" : txtJFYS_XXPTJF_JSFA_JFYS.Text.ToString().Trim();
        ...
        public bool EditSave()
        {
            try
            {
                ...
                xm_model.JFYS_ZXJF_JSFA_SM = txtJFYS_ZXJF_JSFA_SM.Text;
                xm_model.JFYS_ZXJF_JSFA_JFYS = decimal.Parse(txtJFYS_ZXJF_JSFA_JFYS.Text);
                xm_model.JFYS_ZXJF_JSFA_BZ = txtJFYS_ZXJF_JSFA_BZ.Text;
                ...
                xm_model.JFYS_XXPTJF_JSFA_SM = txtJFYS_XXPTJF_JSFA_SM.Text;
                xm_model.JFYS_XXPTJF_JSFA_JFYS = decimal.Parse(txtJFYS_XXPTJF_JSFA_JFYS.Text);
                xm_model.JFYS_XXPTJF_JSFA_BZ = txtJFYS_XXPTJF_JSFA_BZ.Text;
        ...
        protected void btnSaveEnd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (new BuildWord().BuildWord_2015ProjectDeclaration_JSJNJS(tmppath, savepath, xm_model.XMBH))
                {
