...
{
    public partial class role_user_yx : System.Web.UI.Page
    {
        ...
        protected void Grid2_databind()
        {
            ...
            sqlstr = "select * FROM Users,RoleUser where RoleUser.RoleId='" + roleid + "' and Users.user_uid=RoleUser.UserId and Users.xxdm='"+xxdm+"'";
        ...
        protected void btnNew_Click(object sender, EventArgs e)
        {
            ...
            string addUrl = String.Format("role_user_addnew_yx.aspx?id={0}", ids[0]);
