...
{
    public partial class JSJNJS_XMGL_SJW : System.Web.UI.Page
    {
        ...
        protected void databind()
        {
            ...
            //sqlstr = "select * from YLZY  where SFSC!=1  and ZT>=3 and ZT!=4 order by XMBH";
            {
                ...
                //sqlstr = "SELECT '技术技能竞赛' as XMDL, dbo.TYL_XM.ID, dbo.TYL_XM.XMBH, dbo.TYL_XM.XMMC, dbo.TYL_XM.JFYS_ZXJF, dbo.TYL_XM.JFYS_XXPTJF, dbo.XMFJ.XMYSMXWJM, dbo.TYL_XM.SFSC, dbo.TYL_XM.ZT, dbo.TYL_XM.User_Uid FROM dbo.TYL_XM LEFT JOIN dbo.XMFJ ON dbo.TYL_XM.XMBH = dbo.XMFJ.XMBH WHERE  SFSC!=1  and ZT>=3 and ZT!=4 and ZT!=6   order by dbo.TYL_XM.XMBH";
                sqlstr = "SELECT '技术技能竞赛' as XMDL, dbo.JSJNJS_XM.ID, dbo.JSJNJS_XM.XMBH, dbo.JSJNJS_XM.XMMC, dbo.JSJNJS_XM.JFYS_ZXJF, dbo.JSJNJS_XM.JFYS_XXPTJF, dbo.XMFJ.XMYSMXWJM, dbo.JSJNJS_XM.SFSC, dbo.JSJNJS_XM.ZT, dbo.JSJNJS_XM.User_Uid FROM dbo.JSJNJS_XM LEFT JOIN dbo.XMFJ ON dbo.JSJNJS_XM.XMBH = dbo.XMFJ.XMBH  WHERE  SFSC!=1  and ZT>=3 and ZT!=4 and ZT!=6   order by dbo.JSJNJS_XM.XMBH";
            ...
            //sqlstr = "select * from YLZY  where  SFSC!=1 and ZT>=3 and ZT!=4 and XXDM='" + ViewState["xxdm"].ToString() + "' order by XMBH";
            {
                ...
                //sqlstr = "SELECT '通用类' as XMDL, dbo.TYL_XM.ID, dbo.TYL_XM.XMBH, dbo.TYL_XM.XMMC, dbo.TYL_XM.JFYS_ZXJF, dbo.TYL_XM.JFYS_XXPTJF, dbo.XMFJ.XMYSMXWJM, dbo.TYL_XM.SFSC, dbo.TYL_XM.ZT, dbo.TYL_XM.User_Uid FROM dbo.TYL_XM LEFT JOIN dbo.XMFJ ON dbo.TYL_XM.XMBH = dbo.XMFJ.XMBH WHERE  SFSC!=1  and ZT>=3 and ZT!=4 and ZT!=6 and DWMC='" + ViewState["xxmc"].ToString() + "'   order by dbo.TYL_XM.XMBH";
                sqlstr = "SELECT '技术技能竞赛' as XMDL, dbo.JSJNJS_XM.ID, dbo.JSJNJS_XM.XMBH, dbo.JSJNJS_XM.XMMC, dbo.JSJNJS_XM.JFYS_ZXJF, dbo.JSJNJS_XM.JFYS_XXPTJF, dbo.XMFJ.XMYSMXWJM, dbo.JSJNJS_XM.SFSC, dbo.JSJNJS_XM.ZT, dbo.JSJNJS_XM.User_Uid FROM dbo.JSJNJS_XM LEFT JOIN dbo.XMFJ ON dbo.JSJNJS_XM.XMBH = dbo.XMFJ.XMBH  WHERE  SFSC!=1  and ZT>=3 and ZT!=4 and ZT!=6 and DWMC='" + ViewState["xxmc"].ToString() + "'   order by dbo.JSJNJS_XM.XMBH";
                    DataTable dt = DbHelperSQL.Query(sqlstr).Tables[0];
                    Grid1.DataSource = dt;
                    Grid1.DataBind();
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (selectedCount > 0 && selectedCount < 2)
            {
                ...
                if (zt == "1")
                {
                    sqlstr = "update TYL_XM set SFSC=1 where ID=" + Convert.ToInt32(selectedID);
        ...
        protected void Button_sy_Click(object sender, EventArgs e)
        {
            ...
            ViewState["xxmc"] = DropDownList2.SelectedText.Trim();
            databind();
        }
