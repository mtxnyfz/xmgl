<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XMGL_MZWHCC_Add.aspx.cs" Inherits="XMGL.Web.admin.XMGL_MZWHCC" %>
...
<%--                                    <f:Label ID="Label3" runat="server" Label="专业设置时间" Text="专业设置时间:" ColumnWidth="25%" Margin="0 5 2 0" ShowLabel="false"></f:Label>--%>
                                           <f:DatePicker runat="server" Required="true" EnableEdit="false" DateFormatString="yyyy-MM" Label="专业设置时间"   ID="ZYSZSJ1" ShowRedStar="True"  ColumnWidth="50%" Margin="0 5 2 0" ShowLabel="true"  Readonly="false" Enabled="true">
                </f:DatePicker>
                                           <%--<f:TextBox ID="TextBox_SJBYSSJ1" runat="server" ColumnWidth="50%" Label="首届毕业生时间" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                           </f:TextBox>--%>
                                           <f:DatePicker runat="server" Required="true" EnableEdit="false" DateFormatString="yyyy-MM" Label="首届毕业生时间"   ID="TextBox_SJBYSSJ1" ShowRedStar="True"  ColumnWidth="50%" Margin="0 5 2 0" ShowLabel="true"  Readonly="false" Enabled="true">
                </f:DatePicker>
...
<%--                                                      <f:TextBox ID="ZYDT_CSNY1" runat="server" ColumnWidth="50%" Label="出生年月" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                       ...
                                       <f:DatePicker runat="server" Required="true" EnableEdit="false" DateFormatString="yyyy-MM" Label="出生年月"   ID="ZYDT_CSNY1" ShowRedStar="True"  ColumnWidth="50%" Margin="0 5 2 0" ShowLabel="true"  Readonly="false" Enabled="true">
                                        </f:DatePicker>
                                      ...
                                      <f:GroupPanel ID="GroupPanel13" runat="server" Title="教师团队基本情况">
                                          <Items>
                                              <f:Panel ID="Panel27" runat="server" CssClass="formitem" Layout="Column" ShowBorder="False" ShowHeader="False">
                                                  <Items>
                                                      <f:NumberBox ID="JS_ZRJSZS" runat="server" ColumnWidth="50%" DecimalPrecision="0" Label="专任教师总人数" Margin="0 5 2 0" MinValue="0" NoNegative="True" Required="True" ShowRedStar="True" OnTextChanged="JS_ZRJSZS_TextChanged" AutoPostBack="True">
                                                      </f:NumberBox>
                                                      <f:NumberBox ID="JS_GJZCRS1" runat="server" ColumnWidth="50%" DecimalPrecision="0" Label="其中高级职称人数" Margin="0 5 2 0" MinValue="0" NoNegative="True" Required="True" ShowRedStar="True" OnTextChanged="JS_GJZCRS1_TextChanged" AutoPostBack="True">
                                                      </f:NumberBox>
                                                      <%--<f:TextBox ID="JS_GJZCBL1" runat="server" ColumnWidth="50%" Label="其中高级职称比例%" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                                      </f:TextBox>--%>
                                                      <f:NumberBox ID="JS_GJZCBL1" runat="server" ColumnWidth="50%" Label="其中高级职称比例%" Margin="0 5 2 0" MinValue="0" NoNegative="True" Required="True" ShowRedStar="True">
                                                      </f:NumberBox>
                                                      <f:NumberBox ID="JS_SHXRS1" runat="server" ColumnWidth="50%" DecimalPrecision="0" Label="双师型教师人数" Margin="0 5 2 0" MinValue="0" NoNegative="True" Required="True" ShowRedStar="True" OnTextChanged="JS_SHXRS1_TextChanged" AutoPostBack="True">
                                                      </f:NumberBox>
                                       <%--               <f:TextBox ID="ZYFZR_ZYZGZS1" runat="server" ColumnWidth="50%" Label="双师型教师比例%" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                                      </f:TextBox>--%>
                                                      <f:NumberBox ID="ZYFZR_ZYZGZS1" runat="server" ColumnWidth="50%" Label="双师型教师比例%" Margin="0 5 2 0" MinValue="0" NoNegative="True" Required="True" ShowRedStar="True"  AutoPostBack="True">
                                                      </f:NumberBox>
                                                      ...
                                                      <f:DropDownList ID="ZYDT_YWCCR1" runat="server" AutoPostBack="True" ColumnWidth="50%" Label="有无非物质文化遗产传承人（如有请填写以下表格）" Margin="0 5 2 0" Required="True" ShowRedStar="True" OnSelectedIndexChanged="ZYDT_YWCCR1_SelectedIndexChanged">
                                                      </f:DropDownList>
                                                  </Items>
                                              </f:Panel>
                                          </Items>
                                      ...
                                      <f:GroupPanel ID="GroupPanel14" runat="server" Title="非物质文化遗产传承人情况">
                                          <Items>
                                              <f:Panel ID="Panel28" runat="server" CssClass="formitem" Layout="Column" ShowBorder="False" ShowHeader="False">
                                                  <Items>
                                                      <f:TextBox ID="CCR_XM1" runat="server" ColumnWidth="50%" Label="姓名" Margin="0 5 2 0" Required="false" ShowRedStar="True">
                                                      </f:TextBox>
                                                      <f:DropDownList ID="CCR_XB1" runat="server" AutoPostBack="True" ColumnWidth="50%" Label="性别" Margin="0 5 2 0" Required="false" ShowRedStar="True">
                                                      </f:DropDownList>
                                                      <%--<f:TextBox ID="JS_GJZCBL2" runat="server" ColumnWidth="50%" Label="出生年月" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                                      </f:TextBox>--%>
                                       <f:DatePicker runat="server" Required="false" EnableEdit="false" DateFormatString="yyyy-MM" Label="出生年月"   ID="JS_GJZCBL2" ShowRedStar="True"  ColumnWidth="50%" Margin="0 5 2 0" ShowLabel="true"  Readonly="false" Enabled="true">
                                        </f:DatePicker>
                                                      <f:TextBox ID="JS_FWZYCMC1" runat="server" ColumnWidth="50%" Label="非物质文化遗产传承项目名称" Margin="0 5 2 0" Required="false" ShowRedStar="True">
                                                      </f:TextBox>
                                                      <f:DropDownList ID="CCR_ZSJB1" runat="server" AutoPostBack="True" ColumnWidth="50%" Label="证书级别" Margin="0 5 2 0" Required="false" ShowRedStar="True">
                                                      </f:DropDownList>
                                                      <%--<f:TextBox ID="ZYFZR_ZSHDRQ1" runat="server" ColumnWidth="50%" Label="证书获得日期" Margin="0 5 2 0" Required="True" ShowRedStar="True">
                                                      </f:TextBox>--%>
                                        <f:DatePicker runat="server" Required="false" EnableEdit="false" DateFormatString="yyyy-MM" Label="证书获得日期"   ID="ZYFZR_ZSHDRQ1" ShowRedStar="True"  ColumnWidth="50%" Margin="0 5 2 0" ShowLabel="true"  Readonly="false" Enabled="true">
                                        </f:DatePicker>
                                                  </Items>
                                              </f:Panel>
                                          </Items>
                           ...
                           <f:GroupPanel ID="GroupPanel11" Layout="Anchor" Title="&lt;strong&gt;专业点示范作用情况&lt;/strong&gt;" runat="server">
                            <Items>
                                      <f:TextArea ID="TextArea_ZYDSFZYQK1" runat="server" ColumnWidth="80%" EmptyText="&lt;近三年参加行业及省级以上专业研究组织及活动情况、承办行业及省市与专业相关的活动情况以及专业所获荣誉（不超过600字）&gt;" Height="200px" Margin="10 5 10 0" Required="True" ShowRedStar="True" MaxLength="600">
                                      </f:TextArea>
                         ...
                         <f:GroupPanel ID="GroupPanel15" runat="server" Title="&lt;strong&gt;专业建设及人才培养相关情况&lt;/strong&gt;">
                             <Items>
                                 <f:TextArea ID="TextArea_ZYJJ1" runat="server" ColumnWidth="80%" EmptyText="&lt;含专业背景、人才培养特色与创新、专业优势及影响力等情况（不超过600字）&gt;" Height="200px" Label="一、专业点简介" Margin="10 5 10 0" Required="True" ShowRedStar="True" MaxLength="600">
                                 </f:TextArea>
                                 <f:TextArea ID="TextArea_ZYJSQK1" runat="server" ColumnWidth="80%" EmptyText="&lt;含人才培养模式与创新、课程建设、实践教学、校企合作、师资队伍建设、教学条件建设等情况（不超过1500字）&gt;" Height="200px" Label="二、专业建设情况" Margin="10 5 10 0" Required="True" ShowRedStar="True" MaxLength="1500">
                                 </f:TextArea>
                                 <f:TextArea ID="TextArea_RCPYQK1" runat="server" ColumnWidth="80%" EmptyText="&lt;含毕业生就业情况与社会声誉、就业典型案例等（不超过600字）&gt;" Height="200px" Label="三、人才培养情况" Margin="10 5 10 0" Required="True" ShowRedStar="True" MaxLength="600">
                                 </f:TextArea>
                                 <f:TextArea ID="TextArea_ZYJSGH1" runat="server" ColumnWidth="80%" EmptyText="&lt;未来三年专业建设规划，明确建设目标与实施方案（不超过1000字）&gt;" Height="200px" Label="四、下一步专业建设规划" Margin="10 5 10 0" Required="True" ShowRedStar="True" MaxLength="1000">
                                 </f:TextArea>
                             </Items>
                         </f:GroupPanel>
                    </Items>
