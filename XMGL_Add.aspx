                                        ...
                                        <f:GroupPanel ID="GroupPanel4" Layout="Anchor" Title="<strong>申报专业基本情况</strong>" runat="server">
                                            <Items>
                                                ...
                                                <f:Panel ID="Panel18" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                    <Items>
                                                        <f:NumberBox ID="ZRJSS" runat="server" Label="专任教师数（人）" MinValue="0" DecimalPrecision="0" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="30%" Margin="10 5 10 2" Readonly="true" Enabled="true" Text="0"></f:NumberBox>
                                                ...
                                                <f:Form runat="server" Title="填写专业教师基本信息(注意：由于系统问题，如果超过5位教师，<br/>请先添加不超过5位教师的数据，待保存后再从修改界面继续添加其他的教师信息)" ID="Form4">
                                                    <Items>
                                                        <f:Panel ID="Panel19" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                            <Items>
                                                                <f:Panel ID="Panel20" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label runat="server" ID="Label_jsxm" Text="教师姓名：" ShowRedStar="true"></f:Label>
                                                                        <f:TextBox ID="TextBox1_jsxm" Label="教师姓名" Width="200px" runat="server" ShowLabel="false"></f:TextBox>
                                                                    </Items>
                                                                </f:Panel>
                                                                <f:Panel ID="Panel49" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label4" runat="server" Text="出生年月："></f:Label>
                                                                        ...
                                                                        <f:HiddenField ID="HiddenField_csny" runat="server" Text=""></f:HiddenField>
                                                                    </Items>
                                                                </f:Panel>

                                                                <f:Panel ID="Panel50" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label5" runat="server" Text="专/兼职："></f:Label>
                                                                        <f:TextBox ID="DropDownList_zjz1" Label="专/兼职" runat="server" ShowLabel="false" Readonly="true" Enabled="false"></f:TextBox>
                                                                        <f:HiddenField ID="HiddenField_zjz" runat="server" Text=""></f:HiddenField>
                                                                    </Items>
                                                                </f:Panel>

                                                                <f:Panel ID="Panel51" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label6" runat="server" Text="是否双师："></f:Label>


                                                                        <f:TextBox ID="DropDownList_ss1" Label="是否双师" runat="server" ShowLabel="false" Readonly="true" Enabled="false"></f:TextBox>
                                                                        <f:HiddenField ID="HiddenField_ss" runat="server" Text=""></f:HiddenField>
                                                                    </Items>
                                                                </f:Panel>
                                                            </Items>
                                                        ...
                                                        <f:Panel ID="Panel22" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server">
                                                            <Items>
                                                                ...
                                                                <f:Panel ID="Panel52" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label7" runat="server" Text="学历："></f:Label>
                                                                ...
                                                                <f:Panel ID="Panel53" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label8" runat="server" Text="学位："></f:Label>
                                                                ...
                                                                <f:Panel ID="Panel54" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:Label ID="Label9" runat="server" Text="职称等级："></f:Label>


                                                                        <f:TextBox ID="DropDownList_zcdj11" Label="职称等级" runat="server" ShowLabel="false" Readonly="true" Enabled="false"></f:TextBox>
                                                                        <f:HiddenField ID="HiddenField_zcdj" runat="server" Text=""></f:HiddenField>
                                                                    </Items>
                                                                </f:Panel>

                                                                <f:Panel ID="Panel55" runat="server" Margin="5 5 2 10" ColumnWidth="25%" ShowBorder="false" ShowHeader="false">
                                                                    <Items>
                                                                        <f:ContentPanel ID="ContentPanel5" runat="server" ShowBorder="false" ShowHeader="false">
                                                                            <Items>
                                                                            </Items>
                                                                        </f:ContentPanel>
                                                                    </Items>
                                                            ...
                                                            <Toolbars>
                                                                <f:Toolbar ID="Toolbar6" runat="server">
                                                                    <Items>
                                                                        ...
                                                                        <f:Button ID="Button5" Text="删除" runat="server" OnClick="Button5_Click" ConfirmText="确定删除？"></f:Button>
                                                                    </Items>
                                                                </f:Toolbar>
                                                            </Toolbars>
                                                            <Columns>
                                                                ...
                                                                <f:TemplateField HeaderText="专/兼职" ID="ctl16" ColumnID="Panel1_Form2_GroupPanel4_Panel22_Grid2_ctl16">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label10" runat="server" Text='<%#Eval("CSNY")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </f:TemplateField>
                                                                <f:TemplateField HeaderText="是否双师" ID="ctl17" ColumnID="Panel1_Form2_GroupPanel4_Panel22_Grid2_ctl17">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="Label11" runat="server" Text='<%#Eval("ZZJZ")%>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </f:TemplateField>
