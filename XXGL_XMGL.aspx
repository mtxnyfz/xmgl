<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XXGL_XMGL.aspx.cs" Inherits="XMGL.Web.admin.XXGL_XMGL" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="项目申报书(信息管理平台)管理" ShowBorder="false" ShowHeader="True" Layout="VBox"
