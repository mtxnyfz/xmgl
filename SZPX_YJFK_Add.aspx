<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SZPX_YJFK_Add.aspx.cs"
    Inherits="XMGL.Web.admin.SZPX_YJFK_Add" %>
...
<body>
    ...
    <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        Title="SimpleForm" LabelWidth="100px" Width="600px">
        <Rows>
            ...
            <f:FormRow ID="FormRow4" runat="server">
                <Items>
                    <f:TextArea ID="TextArea_yj" runat="server" Height="150px" Label="意见" Width="550px">
                    </f:TextArea>
                </Items>
            </f:FormRow>
        </Rows>
