<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CXYXTJD_XMGL_SJW.aspx.cs" Inherits="XMGL.Web.admin.CXYXTJD_XMGL_SJW" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Panel7" runat="server" />
        <f:Panel ID="Panel7" runat="server" BodyPadding="5px"
            Title="申报项目管理(产教研协同基地)" ShowBorder="false" ShowHeader="True" Layout="VBox"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" Title="Grid1" PageSize="20" ShowBorder="true" BoxFlex="1" AllowPaging="true"
                    ...
                    DataKeyNames="ID,XMBH,ZT,JDMC" OnPageIndexChange="Grid1_PageIndexChange" OnRowDataBound="Grid1_RowDataBound" OnRowCommand="Grid1_RowCommand">
